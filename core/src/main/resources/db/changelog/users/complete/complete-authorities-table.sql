INSERT INTO authorities (title, description,e_authorities, createdat, updatedat) VALUES
      ...
      ('Пользователи запись', 'Право на изменении информации об пользователях','USERS_DATA_WRITE',current_timestamp,current_timestamp),
      ...
      ('Глобальные настройки запись', 'Права на изменении информации об настройках программы','GLOBAL_SETTINGS_WRITE',current_timestamp,current_timestamp)
