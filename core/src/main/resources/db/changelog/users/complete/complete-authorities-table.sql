INSERT INTO authorities (title, description,e_authorities, createdat, updatedat) VALUES
      ('Собственный профиль', 'Чтение и запись изменений собственного профиля','PROFILE_READ_WRITE',current_timestamp,current_timestamp),
      ('Пользователи чтение', 'Право на получение информации об пользователях','USERS_DATA_READ',current_timestamp,current_timestamp),
      ('Пользователи запись', 'Право на изменении информации об пользователях','USERS_DATA_READ_WRITE',current_timestamp,current_timestamp),
