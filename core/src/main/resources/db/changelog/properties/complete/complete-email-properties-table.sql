INSERT INTO email_properties (type, description, email, password,
                              is_enabled, smtphost, smtpenabledssl,
         ...
         ('REGISTER_SENDER','Почта с которой производится рассылка уведомлений о записи на прием, отмены записи и любых других изменений связанных с раписанием премов',
          'test.marketplace20old@gmail.com','nxmiagjiyzcwhqgw',false,'smtp.gmail.com',true,
          true,true,465,587,'SMTP','IMAP','imap.gmail.com',
          true,993),
         ('REGISTER_SENDER','Почта с которой производится рассылка уведомлений о записи на прием, отмены записи и любых других изменений связанных с раписанием премов',
          'test.marketplace2011@gmail.com','nxmiagjiyzcwhqgw',true,'smtp.gmail.com',true,
          true,true,465,587,'SMTP','IMAP','imap.gmail.com',
          true,993)